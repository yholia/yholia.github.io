...
export const cvData: CVData = {
  ...
  skills: [
    { name: "Selenium", level: 100, category: "automation" },
    { name: "Playwright", level: 88, category: "automation" },
    { name: "JUnit / TestNG", level: 90, category: "automation" },
    { name: "NUnit / TUnit", level: 90, category: "automation" },
    { name: "REST Assured", level: 85, category: "automation" },
    { name: "Performance Testing", level: 25, category: "automation" },

    { name: "Java", level: 95, category: "languages" },
    { name: "C#", level: 90, category: "languages" },
    { name: "TypeScript / JS", level: 70, category: "languages" },
    ...
    { name: "Report Portal", level: 85, category: "tools" },
    { name: "Claude Code / AI", level: 88, category: "tools" },

    { name: "Jenkins", level: 88, category: "ci-cd" },
    { name: "TeamCity", level: 82, category: "ci-cd" },
    { name: "GitHub Actions", level: 74, category: "ci-cd" },
    { name: "Azure DevOps", level: 25, category: "ci-cd" },
